...
> 一个纯静态的中文心理测评网站，收录 10 份经典量表，支持可选的 AI 深度解读。
...
| 职业与发展 | 盖洛普 34 才干识别 (自评版) | 102 | ~22 min |
...
- CliftonStrengths® / StrengthsFinder® 是 Gallup, Inc. 的注册商标；本项目使用 **自行撰写** 的 102 题自评版本，仅借鉴公开的 34 才干主题框架，**不是** 盖洛普官方测评，不能替代用于职业评估的官方报告。
